 ...
 * generated in the com.spring.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _UploadFile_QNAME = new QName("http://webservice.spring.com/", "uploadFile");
    private final static QName _UploadFileResponse_QNAME = new QName("http://webservice.spring.com/", "uploadFileResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.spring.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.spring.com/", name = "uploadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.spring.com/", name = "uploadFileResponse")
